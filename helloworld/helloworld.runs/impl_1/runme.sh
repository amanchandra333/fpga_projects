...
HD_PWD='/media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log usart_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source usart_wrapper.tcl -notrace
