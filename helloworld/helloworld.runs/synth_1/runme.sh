...
HD_PWD='/media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usart_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usart_wrapper.tcl
