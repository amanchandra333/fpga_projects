...
HD_PWD='/media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usart_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usart_dlmb_v10_0.tcl
