...
HD_PWD='/media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usart_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usart_axi_smc_0.tcl
