...
read_ip -quiet /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0.xci
...
set_property is_locked true [get_files /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0.xci]
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1 -new_name usart_axi_smc_0 -ip [get_ips usart_axi_smc_0]]

if { $cached_ip eq {} } {

synth_design -top usart_axi_smc_0 -part xc7a35ticsg324-1L -mode out_of_context

#---------------------------------------------------------
# Generate Checkpoint/Stub/Simulation Files For IP Cache
#---------------------------------------------------------
catch {
 write_checkpoint -force -noxdef -rename_prefix usart_axi_smc_0_ usart_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ usart_axi_smc_0_stub.v
 lappend ipCachedFiles usart_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ usart_axi_smc_0_stub.vhdl
 lappend ipCachedFiles usart_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ usart_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles usart_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ usart_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles usart_axi_smc_0_sim_netlist.vhdl

 config_ip_cache -add -dcp usart_axi_smc_0.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips usart_axi_smc_0]
}

rename_ref -prefix_all usart_axi_smc_0_

write_checkpoint -force -noxdef usart_axi_smc_0.dcp

catch { report_utilization -file usart_axi_smc_0_utilization_synth.rpt -pb usart_axi_smc_0_utilization_synth.pb }

if { [catch {
  file copy -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1/usart_axi_smc_0.dcp /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1/usart_axi_smc_0_stub.v /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1/usart_axi_smc_0_stub.vhdl /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1/usart_axi_smc_0_sim_netlist.v /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.runs/usart_axi_smc_0_synth_1/usart_axi_smc_0_sim_netlist.vhdl /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.ip_user_files/ip/usart_axi_smc_0]} {
  catch { 
    file copy -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.v /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.ip_user_files/ip/usart_axi_smc_0
  }
}

if {[file isdir /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.ip_user_files/ip/usart_axi_smc_0]} {
  catch { 
    file copy -force /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.srcs/sources_1/bd/usart/ip/usart_axi_smc_0/usart_axi_smc_0_stub.vhdl /media/makerspace/makerspace_hd/VivadoProjects/helloworld/helloworld.ip_user_files/ip/usart_axi_smc_0
  }
}
