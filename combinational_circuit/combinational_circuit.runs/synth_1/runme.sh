...
HD_PWD='/media/makerspace/makerspace_hd/VivadoProjects/combinational_circuit/combinational_circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb.tcl
